        ...
        <div>
            ...
            <div className="md:grid md:gap-4 md:grid-cols-3">
                ...
                <div>
                    ...
                    {expandedAssets && <button className="rounded-xl my-5 py-2 px-2 bg-slate-600 text-white">Add Asset</button>}
                </div>
                <div>
                    ...
                    {expandedLiabilities && <button className="rounded-xl my-5 py-2 px-2 bg-slate-600 text-white">Add Liability</button>}
                </div>
            </div>
