    ...
    return (
        <header className="sticky z-50 top-0 py-1 md:flex justify-between bg-slate-900 text-white">
            {expandedMenu && <div className="flex flex-col md:flex-row">
                <NavLink to="/" className="text-center py-4 px-5 mx-auto" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>CapyFinance</NavLink>
            ...
            {expandedMenu && <div className="flex flex-col md:block md:py-4">
                <NavLink to="/" className="text-center py-2 px-5 mx-auto" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>About</NavLink>
                <NavLink to="/" className="text-center py-2 px-5 mx-auto" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>Contact</NavLink>
            </div>}
            {expandedMenu && <div className="flex flex-col md:block md:py-4">
                ...
                {!user && <NavLink to="/users/signup" className="text-center py-2 md:py-4 px-5" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>Sign Up</NavLink>}
