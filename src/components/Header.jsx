...
Date: January 9, 2024
Version: 1.0
Description: header component jsx for capy finance client
 */
    ...
    return (
        <header className="sticky z-50 top-0 py-1 md:flex justify-between bg-slate-900 text-white">
            ...
            {expandedMenu && <div className="flex flex-col md:block md:py-4">
                ...
                {user && <NavLink to="/capy-finance-client/" onClick={logoutService} className="text-center py-2 md:py-2 px-5">Logout</NavLink>}
            </div>}
            {expandedMenu && <div onClick={toggleMenu} className="text-center py-2 md:py-4 text-2xl md:hidden">&#127828;</div>}
            <div className="flex justify-between md:hidden">
                {!expandedMenu && <NavLink to="/capy-finance-client/" className="py-2 px-2 md:hidden">CapyFinance</NavLink>}
